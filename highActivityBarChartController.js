app.controller("highActivityBarChartController", function($scope, barChartDataService, globalHighchartOptions) {

    var barChartOptions = {
        chart: {
            type: 'bar',
        },
        colors: barChartDataService.highActivityColors,
        title: {
            text: null
        },
        subtitle: {
        ...
        yAxis: {
            ...
            max: barChartDataService.yAxisMaxHighActivity
        },
        tooltip: {
            enabled: false
        },
        ...
        series: barChartDataService.highActivityDataset,
        exporting: {
            enabled: false
        }
    };
